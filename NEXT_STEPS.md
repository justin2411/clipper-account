...
5. [x] GitHub-Secrets gesetzt (CLOUDFLARE_API_TOKEN, CLOUDFLARE_ACCOUNT_ID, CLIPFORGE_API_URL, CLIPFORGE_API_KEY, GOOGLE_API_KEY) – Verifikation durch ersten grünen deploy.yml-Lauf auf main.
